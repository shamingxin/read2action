...
> **与 `01` 的关系**：`01_项目总说明.md` 为 **最新口径**（含 1.0 冻结、线上地址、9.3 终态等）；本文件中的 **Rules v0.6** 与 **交互文档 v0.7** 为 **历史原文保留**，若与 `01`/`02` 冲突，以 **`01`/`02` + 仓库代码** 为准。  
> **当前阶段**：1.0 已上线冻结；默认 **1.1 准备期** — 未立项前不默认改业务代码（见 `03`、`04`）。
